...
function RightCol() {
  return (
    ...
    >
      ...
      <p className="text-[12px] lg:text-base text-black leading-relaxed mb-8">
      ...
      <div className="flex flex-col md:flex-row gap-4 justify-center md:justify-start">
        ...
        <a
          href="/resume"
          className="px-6 py-3 text-[12px] lg:text-base text-black rounded-full border border-gray-300 font-medium  transition"
        >
          View Resume
        </a>
      </div>
